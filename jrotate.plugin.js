...
;(function($) {
   ...
   $.fn.css = function (arg,value) {
	   ...
	   if ( 
          ( typeof this.get(0) != 'undefined' && typeof _propsObj['transform'] == 'undefined' && ( arg == 'transform' || ( typeof arg == 'object' && typeof arg['transform'] != 'undefined') ) )
          || ( typeof this.get(0) != 'undefined' && typeof _propsObj['transform'] == 'undefined' && ( arg == 'rotate' || ( typeof arg == 'object' && typeof arg['rotate'] != 'undefined') ) )
           ) {
           _propsObj['transform'] = getTransformProperty(this.get(0));
           
           if (_propsObj['transform'] == 'undefined') {
              _propsObj['transform'] = 'none';
           }
       }

       if (arg == 'transform') { arg = _propsObj['transform']; }
